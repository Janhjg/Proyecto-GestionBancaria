...
Definamos que hay que hacer al inicio y como lo haremos, ideas de funciones y operaciones a realizar , añadidos y repartamos tareas. primero montemos la estructura basica del proyecto y despues avanzamos.
usar el archivo **funciones.py** para ir poniendo alli todas ytener limpio **banco.py** hasta despues de pruebas
